...
class EvalCallback(EventCallback):
    ...
    :param verbose: Verbosity level: 0 for no output, 1 for indicating information about evaluation dqnresults
    ...
    def _on_step(self) -> bool:
        ...
        if self.eval_freq > 0 and self.n_calls % self.eval_freq == 0:
            ...
            # Dump log so the evaluation dqnresults are printed with the correct timestep
